...
Configure your API credentials. Choose **one** of the following methods:

**Method 1 — `.env` file (recommended, cross-platform):**
...
The `.env` file is loaded automatically at startup. Example contents:
