...
# Load .env from project root early, so that any environment-variable
# fallbacks in run_pipeline (the child process or in-process import)
# will pick up the values.
